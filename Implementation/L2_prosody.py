...
import L2_prosody_trial_texts #TODO# Fix so that this can be in the Text/L2 folder
import L2_prosody_trial

# If pretest is run, we would like to run two sets of set trial orders. Put pretest_order to 1 or 2

def run_L2_prosody(sound_path, data_path, laptop = 1, pretest = 0, pretest_order = 1):
   ...
   #================================
    ...
    L2_prosody_trial.L2_prosody_instruction_trial(win, sound_path)
   ...
   #================================
    ...
    texts = L2_prosody_trial_texts.texts
    ...
    # Input_data_file:
    input_data_test_file_name = "L2_prosody_test_" + participant_ID + ".json"
    input_data_test_file = data_path +  input_data_test_file_name
    input_data_pretest_ratings_file_name = "L2_prosody_pretest_ratings_" + participant_ID + ".json"
    input_data_pretest_ratings_file = data_path +  input_data_pretest_ratings_file_name
    input_data_pretest_freetext_file_name = "L2_prosody_pretest_freetext_" + participant_ID + ".json"
    ...
    for trial_ind in trials:
        ...
        user_input_test[trial_ind] = L2_prosody_trial.L2_prosody_test_trial(win, text, sound_path, trial_type, trial_nr, yes_input_ctr, request_user_input = 1)
        ...
        if pretest:
            ...
            questions =  [u'Hur tydlig upplever du att talaren var med att hen vill ha respons eller inte?', u'Hur säker var du på att du svarade rätt?',]
    ...
    if pretest:
        ...
        for trial_ind in trials:
            ...
            L2_prosody_trial.L2_prosody_test_trial(win, text, sound_path, trial_type, trial_nr, -1, request_user_input = 0)
